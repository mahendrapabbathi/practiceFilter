...
const ProductDetails = () => {
  ...
  return (
    <div className='px-4 sm:px-10 md:px-16 lg:px-24 mt-16'>
      ...
      <div className='flex flex-col sm:flex-row mt-12 gap-12 justify-between w-[820px]'>
        <div>
          <img src={product.img} className='w-120 px-6 py-16 shadow-sm shadow-black' alt="" />
        </div>
        ...
        <button onClick={()=>addToCart(product.id)} className='bg-black text-white cursor-pointer px-6 py-2 rounded mt-2 hover:bg-gray-800'>Add To Cart</button>
        </div>
      </div>
